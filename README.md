...
* **Frontend:** HTML5, CSS3, React (En aprendizaje)
* **Datos e Infraestructura:** Oracle SQL, AWS (Batch Pipelines)
* **Herramientas:** Git, GitHub, VSCode

### 📊 Proyectos Destacados (En desarrollo / Construcción)

* ⚙️ **AWS Data Pipeline:** Diseño e implementación de un pipeline de procesamiento de Big Data utilizando AWS Batch.
* 🛒 **Despensa App (WIP):** Futura aplicación Full Stack (React/React Native) para la gestión eficiente de inventario doméstico, integrando la API de Open Food Facts (en formación actualmente).

### 📫 Cómo contactar conmigo

* **LinkedIn:** https://www.linkedin.com/in/davidsantonja/
* **Email:** santonjavalles@icloud.com

---
*"Buscando siempre construir aprendizaje robusto, aportar compromiso, ganas y responsabilidad."*
